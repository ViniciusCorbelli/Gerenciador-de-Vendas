<aside class="main-sidebar elevation-4 sidebar-dark-primary" style="overflow-x: hidden;">
    ...
    <a href="index3.html" class="brand-link">
        <span class="brand-text font-weight-light">Gerenciamento de vendas</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
                <a href="{{ route('messages.index') }}"
                    class="nav-link {{ Route::is('messages.index') ? 'active' : '' }}">
            ...
            <li class="nav-item has-treeview">
                <a href="{{ route('sales.index') }}"
                    class="nav-link {{ Route::is('sales.index') ? 'active' : '' }}">
